<!-- Replace YOUR_USERNAME with your GitHub username everywhere in this file -->
<!-- Replace YOUR_EMAIL with your real email -->
<!-- Replace YOUR_LINKEDIN with your LinkedIn profile URL slug -->
...
Currently open to **remote freelance and contract work**.
...
I'm open to freelance projects, remote contracts, and interesting problems.
...
<!---
================================================================
SNAKE ANIMATION — ONE TIME SETUP (takes 5 minutes):
================================================================
1. Inside your profile repo, create this folder path and file:
   .github/workflows/snake.yml

2. Paste this content into snake.yml and save it:
...
4. Click "Generate Snake" → "Run workflow" → "Run workflow" (green button)
5. Wait about 60 seconds — snake will appear on your profile automatically
================================================================
-->
